...
$kioskArtifact = Join-Path $artifactRoot 'matholic-kiosk-0.6.0-rc90-release.apk'
$webPocArtifact = Join-Path $artifactRoot 'matholic-webpoc-0.4.0-rc138-release.apk'
