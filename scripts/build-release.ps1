...
$kioskArtifact = Join-Path $artifactRoot 'matholic-kiosk-0.6.0-rc07-release.apk'
$webPocArtifact = Join-Path $artifactRoot 'matholic-webpoc-0.4.0-rc06-release.apk'
