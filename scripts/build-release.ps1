...
$kioskArtifact = Join-Path $artifactRoot 'matholic-kiosk-0.6.0-rc55-release.apk'
$webPocArtifact = Join-Path $artifactRoot 'matholic-webpoc-0.4.0-rc117-release.apk'
