...
try {
    & .\gradlew.bat clean :probe:testDebugUnitTest :poc:testDebugUnitTest :webpoc:testDebugUnitTest :probe:lintDebug :poc:lintDebug :webpoc:lintDebug :probe:assembleDebug :poc:assembleDebug :webpoc:assembleDebug
