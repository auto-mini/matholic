...
2026-07-24 RC02 실기에서 1~6과 9~10은 통과했다. 추가로 Web POC 강제 종료를 주입해 `WEB_SESSION_FAILED` 잠금, 관리자 PIN, 아래 자체 복구 절차와 정상 왕복 회귀를 확인했다. USB 디버깅을 끈 뒤 ADB 목록에서 A가 사라졌고, 케이블을 분리해 물리 재부팅·자동 실행·복구, 알림창 차단, 홈·최근 앱 버튼 제거와 뒤로가기 무반응을 확인했다. 7~8은 아직 남아 있다.
