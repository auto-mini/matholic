...
같은 signer와 더 높은 versionCode의 Kiosk RC21을 보존형 업데이트했고
Web POC RC15도 보존형 업데이트했다. 이 조합은 자동검증과 비대면 설치 후
검사를 통과했지만 실제 관리자 화면·사이트·카메라·PDF·인쇄 실기는 아직
수행하지 않았다.

- 현재 A: Kiosk `0.6.0-rc21`/code 26, Web POC `0.4.0-rc15`/code 32
- 내부 보관 현재 검증 묶음:
  Kiosk `0.6.0-rc21`/code 26, Web POC `0.4.0-rc15`/code 32
- signer SHA-256: `9d5bd7d9c328df2e5c54b67d1aa2d42caef2674eeace0614bfe2d37c7651f5b7`
- 현재 A: release signer의 Kiosk RC21/Web POC RC15, 기존 Device Owner·전용
...
- RC21/RC15 실제 관리자 화면·사이트·카메라·PDF·인쇄 회귀: **미수행**
