...
같은 signer의 Kiosk RC61·Web POC RC120을 보존형 설치한다. Kiosk DB, Device
Owner와 전용 HOME은 보존됐고 두 설치본의 해시는 보관 artifact와 일치해야 한다.
현재 검증 묶음은 Kiosk RC61, Web POC RC120과 PC 수신기 0.1.5다.
정확한 자동·릴리스 검증과 설치 여부는 `docs/BUILD_VERIFICATION.md`의 최신
절을 기준으로 한다.

- 현재 A: Kiosk `0.6.0-rc61`/code 66, Web POC `0.4.0-rc120`/code 137
- 내부 보관 현재 검증 묶음:
  Kiosk `0.6.0-rc61`/code 66, Web POC `0.4.0-rc120`/code 137,
  PC 수신기 `0.1.5`
- signer SHA-256: `9d5bd7d9c328df2e5c54b67d1aa2d42caef2674eeace0614bfe2d37c7651f5b7`
- 현재 A: release signer의 Kiosk RC61/Web POC RC120, 기존 Device Owner·전용
