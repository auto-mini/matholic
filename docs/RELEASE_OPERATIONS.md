...
같은 signer의 Kiosk RC97·Web POC RC139가 보존형 설치돼 있다. Kiosk DB, Device
Owner와 전용 HOME을 보존했고 두 설치본은 서명·버전·보관 artifact 검증을
통과했다. 현재 보관 검증 묶음은 Kiosk RC97, Web POC RC139와 PC 수신기
0.1.8이다.
...
현재 소스 작업본의 Kiosk RC97은 반별 시작 시각만 설정하는 3시간 자동 반 시간표,
...
- 현재 A: Kiosk `0.6.0-rc97`/code 102, Web POC `0.4.0-rc139`/code 156
- 내부 보관 현재 검증 묶음:
  Kiosk `0.6.0-rc97`/code 102, Web POC `0.4.0-rc139`/code 156,
  PC 수신기 `0.1.8`
- 현재 운영 PC 설치본: PC 수신기 `0.1.8`
- signer SHA-256: `9d5bd7d9c328df2e5c54b67d1aa2d42caef2674eeace0614bfe2d37c7651f5b7`
- Kiosk RC97 APK: 36,901,893 bytes,
  `A5A94E086011E7DDC5FC2015307A96231B595DB38310F16CE8FCE0F3BE90C2F2`
- Web POC RC139 APK: 3,396,754 bytes,
  `2967F5F2011E870B0C6429797055082118955B3D990CF411F751DC791497132E`
- 현재 A: release signer의 Kiosk RC97/Web POC RC139, 기존 Device Owner·전용
