...
사람 손 없이 가능한 검증과 최종 0.3.2 정상 회귀, G302 표시명 교차 매핑은 완료했다. 아래 G303~G305는 자격정보를 A 태블릿 화면에 다시 입력해야 하므로 미수행이다. 자격정보를 채팅, 파일, ADB와 로그로 전달하지 않는다.
...
G301은 0.2.2와 최종 0.3.2에서, G302와 G306·G307·G308은 실제 기기 시험으로 통과했다. G304·G305의 비자격정보 상태 계약도 통과했지만 G303과 실계정 session 기반 G304·G305 전에는 전체 Gate 3 PASS로 판정하지 않는다.
