...
- release RC02는 정의된 운영 인수시험을 완료했다. 현재 보관·A 설치 검증 묶음은 Kiosk RC77/Web POC RC136/PC 수신기 0.1.6이다. A에서 도움말 재터치, PIN 메뉴, 11개 대상 반 목록, 반 전환, 임시 보충 학생 추가·세션 종료 시 제거, 시험계정 Web 정상 로그아웃과 보충 목록 로딩 문구 정리를 통과했다. RC61 QR 카드의 실제 출력·절단·카메라 인식까지 통과했다.
