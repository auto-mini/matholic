...
- release RC02는 정의된 운영 인수시험을 완료했다. 현재 보관 검증 묶음과 실제 A 설치본은 Kiosk RC85/Web POC RC137이며 운영 PC는 수신기 0.1.7이다. A 보존 설치 뒤 UID·firstInstallTime·Device Owner·전용 HOME·Lock Task를 유지했고, RC85의 신규용 카드 관리 메뉴와 무료 4장 표시를 실물 확인했다. 실제 학생정보 입력이나 카드 배정은 하지 않았으며 최종 상태는 QR 대기다. PC 수신기 0.1.7은 운영 설치·독립 자체 점검과 TCP 48129 재기동을 통과했다. RC61 QR 카드의 실제 출력·절단·카메라 인식까지 통과했다.
