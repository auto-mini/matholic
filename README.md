...
- 외부 알림은 현재 요구사항에서 제외했다. release RC02는 정의된 운영 인수시험을 완료했고 Kiosk RC55/Web POC RC117 조합은 보존형 설치를 완료했다. Kiosk RC57/Web POC RC119/PC 수신기 0.1.5는 리뷰 교정 후 검증 대상인 미배포 묶음이다. 실제 학습지에서 하단 수식 키패드의 위치·입력·저장, 답안 현황 지도, 수동 학생 선택과 반 전체 카드 PDF의 물리 출력은 사용자 재확인 대기다.
